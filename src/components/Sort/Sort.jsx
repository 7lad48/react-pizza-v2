...
function Sort({selectedSort, setSelectedSort, enableSortArrow, setEnableSortArrow}) {
    ...
    //const [enableSortArrow, setEnableSortArrow] = React.useState(false);
    ...
    return (
        <div className={styles.sort}>
            ...
            <div onClick={ () => {setEnableSortArrow(!enableSortArrow)} } className={enableSortArrow ? styles.arrow : `${styles.arrow} ${styles.active}`}>
